# F-3 (occlusion necessity test): readout for DiffusionDrive
...
| --- | --- | --- | --- |
| $b_{ghost}$ (original response) | -0.0289 | [-0.0859, 0.0216] | no |
| $b_{occ}$ (residual after occlusion) | -0.0110 | [-0.0508, 0.0304] | no |
| $b_{ctrl}$ (patch elsewhere) | -0.0120 | [-0.0477, 0.0291] | no |

| Quantity | Value |
| --- | --- |
| **Necessity ratio $R$ (primary)** | **+0.052 [-0.086, 0.184]** |
| Control arm $R_{ctrl}$ (should be ≈ 0) | +0.026 [-0.13, 0.151] |
| Events past the gate | 243 |
