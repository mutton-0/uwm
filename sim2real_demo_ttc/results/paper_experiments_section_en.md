...
only. An amendment ledger is maintained throughout; the experiments reported here registered **59**
...
but to exclude the case in which numbers look good while meaning nothing. This work registered 59
...
> Sources: `amendments.md` (all 59 amendments), `analytic_vs_empirical.md`,
