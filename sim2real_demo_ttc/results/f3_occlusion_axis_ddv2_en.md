# F-3 (occlusion necessity test): readout for DiffusionDriveV2
...
| --- | --- | --- | --- |
| $b_{ghost}$ (original response) | -0.1803 | [-0.3487, 0.0032] | no |
| $b_{occ}$ (residual after occlusion) | -0.2060 | [-0.3707, -0.029] | **yes** |
| $b_{ctrl}$ (patch elsewhere) | -0.1767 | [-0.3461, 0.0074] | no |

| Quantity | Value |
| --- | --- |
| **Necessity ratio $R$ (primary)** | **+0.135 [-0.094, 0.367]** |
| Control arm $R_{ctrl}$ (should be ≈ 0) | +0.074 [-0.254, 0.413] |
| Events past the gate | 264 |
