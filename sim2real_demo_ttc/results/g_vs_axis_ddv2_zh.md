# G-VS（分割一致性）：DiffusionDriveV2 的读数
...
| 臂 | mIoU | 95% CI | 含义 |
| --- | --- | --- | --- |
| **trained** | **0.3475** | [0.3343, 0.3606] | 训练好的模型 |
| random_init | 0.3316 | [0.3146, 0.3479] | 同架构随机初始化（control task 地板） |
...
| **selectivity（主读数）** | **+0.0159 [-0.0029, 0.0353]** |
