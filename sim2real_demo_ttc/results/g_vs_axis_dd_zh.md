...
| 臂 | mIoU | 95% CI | 含义 |
| --- | --- | --- | --- |
| **trained** | **0.3822** | [0.369, 0.3952] | 训练好的模型 |
| random_init | 0.3441 | [0.3275, 0.3605] | 同架构随机初始化（control task 地板） |
...
| **selectivity（主读数）** | **+0.0381 [0.0211, 0.0551]** |
