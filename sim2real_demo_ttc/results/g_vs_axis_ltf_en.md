# G-VS (segmentation consistency): readout for LTF
...
| --- | --- | --- | --- |
| **trained** | **0.3672** | [0.353, 0.3814] | the trained model |
| random_init | 0.3481 | [0.3326, 0.364] | same architecture, randomly initialized (control-task floor) |
...
| **selectivity (primary readout)** | **+0.0191 [-0.0006, 0.0385]** |
