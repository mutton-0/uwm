...
The behavioural readout agrees: synthetic night raises planned speed by up to $2.05$\,m/s,
where deleting the lead vehicle from the image raises it by $0.23$\,m/s. Two independent
readouts---representation geometry and output trajectory---point to the same mechanism, in
four architectures.
