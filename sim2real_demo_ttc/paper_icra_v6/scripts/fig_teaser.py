...
ax.plot(range(len(BINS)),GC["gt"],color="#52514e",ls=(0,(3,2)),lw=1.1,label="logged human vs.\neach blind plan")
ax.fill_between(range(len(BINS)),GC["gt_lo"],GC["gt_hi"],color="#9a998f",alpha=0.20,lw=0)
