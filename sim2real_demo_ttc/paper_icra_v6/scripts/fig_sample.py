...
EXC={"exposure":"#1f77d0","CFR":"#7047c0","SP":"#7a2f9e","HS":"#0b0b14"}
...
b=ax[1]; V=[("CFR","CFR < 1","#7047c0"),("exposure","exposure ≠ human","#1f77d0"),("HS","HS ≠ 0","#0b0b14")]
XMAX=3000*1/12.0
for j_,(k,nm,c) in enumerate(V):
    ...
    b.text(0.10,y+0.30,nm,fontsize=6.3,color="#52514e",va="bottom")
b.set_yticks([]); b.set_ylim(-0.6,(len(V)-1)*1.35+0.75); b.set_xscale("log"); b.set_xlim(0.09,XMAX*1.2)
