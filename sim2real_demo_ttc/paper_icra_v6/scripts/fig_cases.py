...
plt.rcParams.update({"font.family":"Nimbus Roman","mathtext.fontset":"stix","font.size":8.6,"axes.linewidth":0.6,"axes.edgecolor":"#52514e",
...
for y,m in zip(ys,MM):
    ...
    c.text(left+0.6,y,f"{g}/{g+n+b}",va="center",ha="left",fontsize=6.6,color="#52514e")
c.set_yticks(ys); c.set_yticklabels([SH[m] for m in MM],fontsize=6.8)
...
fig.legend(handles=hh,frameon=False,fontsize=6.4,loc="upper center",bbox_to_anchor=(0.5,0.02),ncol=2,handletextpad=0.3,labelspacing=0.2,columnspacing=1.2)
