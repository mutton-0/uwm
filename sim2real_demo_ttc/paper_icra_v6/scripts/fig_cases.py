...
d.scatter(I[rest],F[rest],s=2.4,c=CI[rest],alpha=0.30,lw=0,zorder=3)
d.scatter(I[bad],F[bad],s=9,facecolor="none",edgecolor="#b3412c",lw=0.6,zorder=5)
d.scatter(I[real],F[real],s=9,facecolor="none",edgecolor="#2f7d4f",lw=0.6,zorder=5)
LOFF={"autovla":(4.5,3.6),"ltf":(4.5,-3.0)}
for m in MM:
