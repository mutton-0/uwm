...
d.legend(frameon=False,fontsize=4.8,loc="upper center",bbox_to_anchor=(0.5,-0.30),ncol=2,handletextpad=0.3,labelspacing=0.2,columnspacing=1.2,borderpad=0.1)
