...
plt.rcParams.update({"font.family":"Nimbus Roman","mathtext.fontset":"stix","font.size":8.3,"axes.spines.top":False,"axes.spines.right":False,"axes.linewidth":0.6,
...
fig,ax=plt.subplots(1,2,figsize=(3.45,2.0),gridspec_kw={"wspace":0.42})
# (b)
...
b.set_xlabel("input ego speed (m/s)",fontsize=7.2,labelpad=0.5); b.set_ylabel("collision with pedestrian (%)",fontsize=7.2,labelpad=1); b.set_xticks([2,4,6,8]); b.tick_params(labelsize=6.7,length=2)
b.legend(handles=[plt.Line2D([],[],color="#52514e",lw=1.2,label="visible"),plt.Line2D([],[],color="#52514e",lw=0.9,ls=(0,(2,1.5)),label="removed")],frameon=False,fontsize=6.7,loc="upper left",handlelength=1.5,labelspacing=0.15,borderpad=0.1)
b.set_title("(a) collision vs. speed",fontsize=7.7,loc="left",pad=2)
...
c.set_title("(b) hazard sensitivity",fontsize=7.7,loc="left",pad=2)
