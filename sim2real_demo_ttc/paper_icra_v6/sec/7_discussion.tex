...
pedestrian, only \NumCfRealPct\% meet all three conditions, and displacement alone would have ranked first
the policy with the most sub-1.5\,s encounters.
The exam that no current benchmark reports is scaling: whether the response grows when the hazard
does. Five policies show a negative scaling coefficient; the one positive value, DiffusionDriveV2's, sits
below 0.15.
...
pedestrian, in daylight and at night. We then plan to validate the diagnoses against the same policies' behaviour on a real
