...
\caption{\textbf{The Check-Up framework.} Pixel-level paired data (a) yield the two causal axes (b), on which five exams issue a prognosis for the target domain (c).}
%120
