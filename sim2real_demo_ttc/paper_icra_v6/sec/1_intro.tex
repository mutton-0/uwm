...
No evaluation yet measures how a policy will perform in the target domain, so organisations fall back
on testing and post-training in the deployment setting itself, rider-only fleets accumulating tens of
millions of miles before a safety claim~\cite{kusano2025waymo56m} or a robot policy improved on its own
deployments~\cite{pi2025pistar06}, a loop whose cost in real-world miles is
prohibitive~\cite{kalra2016driving}.
