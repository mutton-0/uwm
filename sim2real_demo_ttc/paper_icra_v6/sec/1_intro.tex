...
We propose a \emph{check-up}:
% 其中我们设计了像素级别的配对数据，设计捕捉faithfulness displacement F轴和 interference displacement I轴。
a short list of exams, each with a control and a known normal range,
...
edit (\cref{fig:method}). The central exam is a \emph{hazard-sensitivity curve}, measuring how much farther the whole
