...
reward proxies~\cite{li2024egostatus,jaeger2023hidden}, and closed-loop benchmarks~\cite{jia2024bench2drive} score a policy in simulation; we read released policies on real frames. We show that the six-policy spread is carried by a single gate.
