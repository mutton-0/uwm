...
\label{eq:cfr}
\end{equation}
A policy for which lighting is irrelevant has $\CFR\gg1$. The thresholds of \cref{tab:exams} ($\HS\ge0.15$, $\mathrm{Sc}>0$, $\SP\ge0.8$, exposure within $[0.8,1.2]$, $\CFR>1$) are reference thresholds we set, not population norms.
