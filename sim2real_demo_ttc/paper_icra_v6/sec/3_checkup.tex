...
itself---and $I$ the \emph{interference} displacement---the change the same policy produces under an edit that carries no driving-relevant information, and therefore its own jitter floor. A policy that
...
night scene, and we refer to it as the \emph{night-style perturbation}, with $(\gamma,g,s,\sigma)=(2.2,0.45,0.45,7/255)$ and a blue tint (\cref{fig:method}a).
