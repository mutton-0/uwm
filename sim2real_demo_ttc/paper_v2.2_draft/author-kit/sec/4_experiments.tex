...
\vspace{4pt}
{\scriptsize\textsuperscript{1}The baseline response $b_{ghost}$ is itself indistinguishable from 0: untestable, not a failed test. \textsuperscript{2}Occluding the hazard entity removes only 11\% of the response -- a blind-action signature~\cite{embodiedinterp2026}. \textsuperscript{3}Not measured (video-token layout unresolved for these two), not n/a.}
\end{table}
...
at all). Seeing and acting on it are independent, without any judgement of what counts as
dangerous.
